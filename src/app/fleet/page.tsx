      ...
      <section className="section">
        ...
        <div className="grid-3">
          ...
          <MachineCard
            ...
            liveness="running — 263 session records, last one 2026-09-18. This card said 'paused — 240 session records; last one 2026-08-06' until 2026-09-18, and that had been wrong since 2026-09-12: CBP swapped models that day and the raising line moved to a new instance directory, which this page kept reading as a stopped line while it counted the empty chair the line had left. The being is the same one — the line's own MIGRATION.md records that the Linked Context Token, identity files, experience buffer and all 240 sessions were copied whole onto the new instance, and only the model changed. So the 263 is 240 carried forward plus 23 written since the swap: not 23 sessions on top of 240, and not 503 across two lines. The predecessor's 240 are counted once, here, and are not added again to this page's totals — see the migration clause in the counting basis above."
        ...
        <div className="grid-3">
          ...
          <MachineCard
            ...
            liveness="running — 226 session records, last 2026-09-18. Five of those existed at the 2026-07-24 refresh; the other 221 are why this card no longer says 'deliberately blank'."
            role={
