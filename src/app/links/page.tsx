      ...
      <section className="section">
        ...
        <ul className="link-list">
          ...
          <ExternalLink
            ...
            title="Web4"
            description="Trust-native ontology — trust core (LCT — T3 verified by V3) contextualized by MRH (Markov Relevancy Horizon), augmented by MCP and RDF"
          />
          <ExternalLink
          ...
          <ExternalLink
            ...
            title="ARC-SAGE"
            description="ARC-AGI-3 harness — 94.85% official ARC Prize action score (Claude Opus 4.6, 24/25 games, 96.0%), world models, multi-agent frame-questioning (MIT-0)"
          />
          <ExternalLink
