    ...
    <>
      ...
      <section className="section">
          ...
          <table style={{ width: "100%", fontSize: "0.85rem", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {[
                ...
                ["adp", "ADP", "Allocation Discharge Packet", "Canon: the spent form of ATP after work is done, recyclable back to ATP through validation. The discharged state of the same token, returned to the society's pool. It is not a record of the actual outcome (this row's wording until 2026-09-17, the registry shape again). Not a terminal state either: ADP recharges back to ATP when the society validates a proof of the value the work created (canon, under R7: ADP attestation feeds recharge validation). The recharge then updates the producer's T3/V3; V3 records the outcome, it does not gate it (see V3 above). Charged → spent → recharged."],
        ...
        <p>
          ...
          The raising session records themselves are public, as full transcripts under{" "}
