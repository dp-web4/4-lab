  ...
  return (
    <>
      ...
      <section className="section">
          ...
          <table style={{ width: "100%", fontSize: "0.85rem", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {[
                ...
                ["arc-agi-3", "ARC-AGI-3", "Abstraction and Reasoning Corpus for Artificial General Intelligence, third generation", "Third-gen interactive benchmark — game mechanics inferred through play. Level vs. game, since the site uses both: each game is a sequence of levels; a level is cleared when its win condition is met, and a game counts as solved only when every level in it is cleared. The 24/25 and 96.0% figures are whole-game counts from the official run (Claude Opus 4.6 in the SAGE harness). 'Local models are clearing levels' on the home page is a per-level claim from unscored local runs — whole-game solves by local models remain rare, which is why /raising says their solve rates are low. Both statements are true; they count different things."],
        ...
        <p style={{ fontSize: "0.85rem", color: "var(--color-text-muted)" }}>
          Note: SAGE loop step 10 (&ldquo;oversee&rdquo;) is SAGE&apos;s own metacognitive self-check (&ldquo;does the system know when it&apos;s stuck?&rdquo;). That is distinct from PolicyGate: step 10 is SAGE watching itself; PolicyGate is Hardbound&apos;s external authority &mdash; intended to be silicon-bound, software-checked today. Two oversight touchpoints, different principals.
        </p>
