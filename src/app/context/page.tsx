          ...
          <table style={{ width: "100%", fontSize: "0.85rem", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {[
                ...
                ["v3", "V3", "Valuation / Veracity / Validity", "Three-component value tensor complementary to T3: worth assessed, claims truthful, reasoning sound. “Validity” here names V3's tensor component, not the methodological sense (internal/external/construct validity) this page's evidence tiers below also use — same word, unrelated meanings."],
